...
public class OTObject : MonoBehaviour
{
	...
	void AddCollider()
	{
			...
			if (colliderType == ColliderType.Shape)
		{
			if (!box2DPhysics && GetComponent<MeshCollider>()== null)
			{
				...
				#if UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_4_0 || UNITY_4_1 || UNITY_4_2
				#else	
				if (mesh == null && GetComponent<Renderer>() is SpriteRenderer)
		...
		#if UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_4_0 || UNITY_4_1 || UNITY_4_2
		#else	
		otCollider2D = GetComponent<Collider2D>();
		#endif
	}
	...
	public void AssignCollider(OTObject prototype)
	{
		#if UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_4_0 || UNITY_4_1 || UNITY_4_2
		#else	
		if (prototype.GetComponent<Collider2D>()!=null)
		{
			if (prototype.GetComponent<Collider2D>() is BoxCollider2D)
			{
				if (otCollider2D==null)			
					otCollider2D = gameObject.AddComponent<BoxCollider2D>() as BoxCollider2D;
				(otCollider2D as BoxCollider2D).isTrigger = (prototype.GetComponent<Collider2D>() as BoxCollider2D).isTrigger;
				(otCollider2D as BoxCollider2D).offset = (prototype.GetComponent<Collider2D>() as BoxCollider2D).offset;
				(otCollider2D as BoxCollider2D).size = (prototype.GetComponent<Collider2D>() as BoxCollider2D).size;
				//(otCollider as BoxCollider2D).enabled = (protoType.collider2D as BoxCollider2D).enabled;
			}
			else
				if (prototype.GetComponent<Collider2D>() is CircleCollider2D)
			{
				if (otCollider2D==null)			
					otCollider2D=gameObject.AddComponent<CircleCollider2D>() as CircleCollider2D;
				(otCollider2D as CircleCollider2D).isTrigger = (prototype.GetComponent<Collider2D>() as CircleCollider2D).isTrigger;
				(otCollider2D as CircleCollider2D).offset = (prototype.GetComponent<Collider2D>() as CircleCollider2D).offset;
				(otCollider2D as CircleCollider2D).radius = (prototype.GetComponent<Collider2D>() as CircleCollider2D).radius;
				//(otCollider2D as CircleCollider2D).enabled = (protoType.collider2D as CircleCollider2D).enabled;
			}
			else
				if (prototype.GetComponent<Collider2D>() is PolygonCollider2D)
			{
				if (otCollider2D==null)			
					otCollider2D=gameObject.AddComponent<PolygonCollider2D>() as PolygonCollider2D;
				(otCollider2D as PolygonCollider2D).isTrigger = (prototype.GetComponent<Collider2D>() as PolygonCollider2D).isTrigger;
				//(otCollider2D as PolygonCollider2D).enabled = (prototype.collider2D as PolygonCollider2D).enabled;
			}
		}
		#endif
		if (prototype.GetComponent<Collider>() !=null)
		{
			if (prototype.GetComponent<Collider>() is BoxCollider)
			{
				if (otCollider==null)			
					otCollider = gameObject.AddComponent<BoxCollider>() as BoxCollider;
				(otCollider as BoxCollider).isTrigger = (prototype.GetComponent<Collider>() as BoxCollider).isTrigger;
				...
				if (prototype.GetComponent<Collider>() is SphereCollider)
			{
				if (otCollider==null)			
					otCollider=gameObject.AddComponent<SphereCollider>() as SphereCollider;
				(otCollider as SphereCollider).isTrigger = (prototype.GetComponent<Collider>() as SphereCollider).isTrigger;
				...
				if (prototype.GetComponent<Collider>() is MeshCollider)
			{
				if (otCollider==null)	
				{
				...
				(otCollider as MeshCollider).isTrigger = (prototype.GetComponent<Collider>() as MeshCollider).isTrigger;
				(otCollider as MeshCollider).enabled = (prototype.GetComponent<Collider>() as MeshCollider).enabled;
			}
		}
	}
	...
	{	
		...
		otRenderer = GetComponent<Renderer>();
		if (GetComponent<Renderer>() is MeshRenderer)
		{
	...
	public void BoundBy(OTObject o, Vector2 expand)
	{
		...
		#if UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_4_0 || UNITY_4_1 || UNITY_4_2
		#else	
		if (this is OTUnitySprite && GetComponent<Renderer>() is SpriteRenderer)
		{
			SpriteRenderer r = GetComponent<Renderer>() as SpriteRenderer;
