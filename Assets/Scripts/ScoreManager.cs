...
public class ScoreManager : MonoBehaviour 
{
	...
	IEnumerator ShowResults(string results, Color col)
	{
		...
		roundWinnerTxt.GetComponent<Renderer>().enabled = true;
		...
		roundNextTxt.GetComponent<Renderer>().enabled = true;
		...
		StartNextRound();
		roundWinnerTxt.GetComponent<Renderer>().enabled = false;
		...
		roundNextTxt.GetComponent<Renderer>().enabled = false;
	}
